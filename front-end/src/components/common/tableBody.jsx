      ...
      <div>
        {data.map((item) => (
          <Link
            ...
            to={`/aTask/${item._id}`}
          >
            <div className={`${styles.taskCol} ps-4`}>{item.title}</div>
            <div className={`${styles.descriptionCol} ${styles.taskCell}`}>
              {item.description}
            </div>
            <div
              className={`${styles.typeCol} ${styles.taskCell} py-2 border-start border-2`}
            >
              {item.type.name}
            </div>
            <div
              className={`${styles.completeCol} ${styles.taskCell} d-flex align-items-center justify-content-center`}
            >
              <button
                type="button"
